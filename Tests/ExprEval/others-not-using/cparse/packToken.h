...
class packToken {
 ...
 public:
  ...
  packToken(int d) : base(new Token<int64_t>(d, INT_TOKTYPE)) {}
  packToken(int64_t l) : base(new Token<int64_t>(l, INT_TOKTYPE)) {}
  packToken(size_t s) : base(new Token<int64_t>(s, INT_TOKTYPE)) {}
